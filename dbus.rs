// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.DBus -p /org/freedesktop/DBus`, see https://github.com/diwic/dbus-rs
use dbus;
...
pub trait OrgFreedesktopDBusProperties {
    ...
    fn set(
        ...
        arg0: &str,
        arg1: &str,
        arg2: arg::Variant<Box<dyn arg::RefArg>>,
    ) -> Result<(), dbus::Error>;
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target = T>> OrgFreedesktopDBusDebugStats
    for blocking::Proxy<'a, C>
{
    fn get_stats(&self) -> Result<arg::PropMap, dbus::Error> {
